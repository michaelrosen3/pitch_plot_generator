...
def display_summary_statistics(pitcher_data):
    ...
    mean_pfx.columns = ['Horizontal Break (inches)', 'Induced Vertical Break (inches)','Release Height (feet)','Velocity (mph)']
    mean_pfx = mean_pfx[['Induced Vertical Break (inches)', 'Horizontal Break (inches)','Release Height (feet)','Velocity (mph)']]
